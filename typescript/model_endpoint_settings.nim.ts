import {EndpointIPAMConfig} from "./model_endpoint_ipam_config.nim";
//
// Docker Engine API
// 
...
export interface EndpointSettings {
  ...
  driverOpts?: {[key:string]: string} // DriverOpts is a mapping of driver options and values. These options are passed directly to the driver and are driver specific. 
}
