import {TaskSpecPlacementPreferencesInner} from "./model_task_spec_placement_preferences_inner.nim";
import {Platform} from "./model_platform.nim";
//
// Docker Engine API
// 
...
export interface TaskSpecPlacement {
  ...
  preferences: [TaskSpec_Placement_Preferences_inner] // Preferences provide a way to make the scheduler aware of factors such as topology. They are provided in order from highest to lowest precedence. 
  maxReplicas:Number // Maximum number of replicas for per node (default value is 0, which is unlimited) 
