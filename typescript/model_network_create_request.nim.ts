import {IPAM} from "./model_ipam.nim";
//
// Docker Engine API
// 
...
export interface NetworkCreateRequest {
 ...
 Numberernal: Boolean // Restrict external access to the network.
  ...
  options: {[key:string]: string} // Network specific options to be used by the drivers.
