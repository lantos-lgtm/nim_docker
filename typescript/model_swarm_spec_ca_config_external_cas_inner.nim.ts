...
export interface SwarmSpecCAConfigExternalCAsInner {
  ...
  // 
  protocol: Protocol // Protocol for communication with the external CA (currently only cfssl is supported). 
  URL: string // URL where certificate signing requests should be sent. 
  options: {[key:string]: string} // An object with key/value pairs that areNumbererpreted as protocol-specific options for the external CA driver. 
