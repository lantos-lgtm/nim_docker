import {EventActor} from "./model_event_actor.nim";
//
// Docker Engine API
// 
...
export interface EventMessage {
  ...
  type: Type // The  of object emitting the event
  action: string // The  of event
  actor: EventActor
  scope: Scope // Scope of the event. Engine events are local scope. Cluster (Swarm) events are swarm scope. 
