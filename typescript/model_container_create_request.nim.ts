import {NetworkingConfig} from "./model_networking_config.nim";
import {CgroupnsMode, Isolation, HostConfig} from "./model_host_config.nim";
...
export interface ContainerCreateRequest {
  ...
  // exposedPorts: {[key:string]: object} // An object mapping ports to an empty object in the form:  {\"<port>/<tcp|udp|sctp>\": {}} 
  exposedPorts?: {[key:string]: {[key:string]: string}} // An object mapping ports to an empty object in the form:  {\"<port>/<tcp|udp|sctp>\": {}} 
  ...
  // volumes: {[key:string]: object} // An object mapping mount point paths inside the container to empty objects. 
  volumes?: {[key:string]: {[key:string]: string}} // An object mapping mount point paths inside the container to empty objects. 
  ...
  labels: {[key:string]: string} // User-defined key/value metadata.
  stopSignal: string // Signal to stop a container as a string or unsignedNumbereger. 
  stopTimeout:Number // Timeout to stop a container in seconds.
