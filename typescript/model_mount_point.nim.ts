...
export interface MountPoint {
  ...
  type: Type // The mount type:  - bind a mount of a file or directory from the hostNumbero the container. - volume a docker volume with the given Name. - tmpfs a tmpfs. - npipe a named pipe from the hostNumbero the container. 
  ...
  propagation: string // Propagation describes how mounts are propagated from the hostNumbero the mount point, and vice-versa. Refer to the [Linux kernel documentation](https://www.kernel.org/doc/Documentation/filesystems/sharedsubtree.txt) for details. This field is not used on Windows. 
}
