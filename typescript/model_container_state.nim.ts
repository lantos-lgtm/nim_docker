import {Status, Health} from "./model_health.nim";
//
// Docker Engine API
// 
...
export interface ContainerState {
  ...
  status: Status // String representation of the container state. Can be one of \"created\", \"running\", \"paused\", \"restarting\", \"removing\", \"exited\", or \"dead\". 
  running: Boolean // Whether this container is running.  Note that a running container can be _paused_. The Running and Paused Booleaneans are not mutually exclusive:  When pausing a container (on Linux), the freezer cgroup is used to suspend all processes in the container. Freezing the process requires the process to be running. As a result, paused containers are both Running _and_ Paused.  Use the Status field instead to determine if a container's state is \"running\". 
  ...
  dead: Boolean
  pid:Number // The process ID of this container
  exitCode:Number // The last exit code of this container
  error: string
