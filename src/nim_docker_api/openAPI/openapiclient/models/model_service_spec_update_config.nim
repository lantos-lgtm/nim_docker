...
type ServiceSpecUpdateConfig* = object
  ...
  parallelism*: int64 ## Maximum number of tasks to be updated in one iteration (0 means unlimited parallelism). 
  delay*: int64 ## Amount of time between updates, in nanoseconds.
  failureAction*: FailureAction ## Action to take if an updated task fails to run, or stops running during the update. 
  monitor*: int64 ## Amount of time to monitor each updated task for failures, in nanoseconds. 
