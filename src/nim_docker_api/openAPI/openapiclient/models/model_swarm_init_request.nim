...
type SwarmInitRequest* = object
  ...
  dataPathPort*: int ## DataPathPort specifies the data path port number for data traffic. Acceptable port range is 1024 to 49151. if no port is set or is set to 0, default port 4789 will be used. 
  defaultAddrPool*: seq[string] ## Default Address Pool specifies default subnet pools for global scope networks. 
  forceNewCluster*: bool ## Force creation of a new swarm.
