...
type ContainerState* = object
  ...
  paused*: bool ## Whether this container is paused.
  restarting*: bool ## Whether this container is restarting.
  oOMKilled*: bool ## Whether this container has been killed because it ran out of memory. 
  dead*: bool
  pid*: int ## The process ID of this container
  exitCode*: int ## The last exit code of this container
  error*: string
