...
type Task* = object
  ...
  assignedGenericResources*: seq[GenericResources_inner] ## User-defined resources can be either Integer resources (e.g, `SSD=3`) or String resources (e.g, `GPU=UUID1`). 
  status*: Task_Status
