...
type SystemVersion* = object
  ## Response of Engine API: GET \"/version\" 
  platform*: SystemVersion_Platform
  components*: seq[SystemVersion_Components_inner] ## Information about system components 
  ...
  experimental*: bool ## Indicates if the daemon is started with experimental features enabled.  This field is omitted when empty / false. 
